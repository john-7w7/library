...
<label>Ingrese la identificación de correo electrónico</label>
<input class="form-control" type="email" name="email" required autocomplete="off" />
</div>

<div class="form-group">
<label>Ingrese el número de registro móvil</label>
...
<input type="text" class="form-control1"  name="vercode" maxlength="5" autocomplete="off" required  style="height:25px;" />&nbsp;<img src="captcha.php">
 ...
 <button type="submit" name="change" class="btn btn-info">Cambia la contraseña</button> | <a href="index.php">Acceso</a>
</form>
 </div>
</div>
</div>
