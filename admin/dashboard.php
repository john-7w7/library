...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">PANEL DE ADMINISTRACIÓN</h4>
...
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$Portadas=$query->rowCount();
?>


                            <h3><?php echo htmlentities($Portadas);?></h3>
                            Portadas Agregadas
                        </div>
                    </div>
