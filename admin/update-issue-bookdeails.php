...
<head>
    ...
    <title>SIOB | Detalles del libro emitido</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Detalles del libro emitido</h4>
...
<div class="form-group">
<label>Fecha de devolución del libro :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Devolver libro </button>
