...
$isbn=$_POST['isbn'];
$price=$_POST['price'];
$sql="INSERT INTO  tblbooks(BookName, Portada,CatId,AuthorId,ISBNNumber,BookPrice) VALUES(:bookname,:Portada, :category,:author,:isbn,:price)";
...
<head>
    ...
    <title>SIOB | Añadir Portada del libro</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Añadir portada del   libro</h4>
...
<div class="form-group">
<label>Numero ISBN<span style="color:red;">*</span></label>
